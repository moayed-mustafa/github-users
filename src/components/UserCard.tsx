        ...
        <Grid container spacing="2" direction="column" >
          <Grid item container wrap="wrap" >
            ...
            <Grid item xs={12} sm={5}>
              <Typography variant="body1" color="secondary">Joined {created_at}</Typography>
            </Grid>
            <Grid item xs={12} >
          ...
          {/* TODO: just add the icons + clean up some */}
          <Grid container item xs={12} spacing="1" wrap="wrap" marginTop="12px">
            <Grid item xs={6}>
              <Typography variant="body1">{user?.location ? user.location : "not available"}</Typography>
            </Grid>
            <Grid item xs={6}>
              <Typography variant="body1">{user.twitter_username ? user.twitter_username : "not available"}</Typography>
            </Grid>
            <Grid item xs={6}>
              <Typography variant="body1">{user?.repos_url.slice(0, 23)}</Typography>
            </Grid>
            <Grid item xs={6}>
              <Typography variant="body1">{user?.company ? user.company : "not available"}</Typography>
            </Grid>
